---
name: plan-marshall-manage-plan-documents
...
The canonical argparse surface for `manage-plan-documents.py`. The plugin-doctor `missing-canonical-block` rule checks that this section is PRESENT,
