...
class TestClaudeGetExtractSignal:
    def test_claude_reduces_a_signal_bearing_transcript(self, projects_at_tmp):
        ...
        result = _parse(ClaudeRuntime().chat_extract_signal('22222222-2222-2222-2222-222222222222'))
    ...
    def test_claude_missing_transcript_is_noop(self, projects_at_tmp):
        ...
        result = _parse(ClaudeRuntime().chat_extract_signal('22222222-2222-2222-2222-222222222299'))
    ...
    def test_claude_reaches_the_reducer_via_attribute_access(self, projects_at_tmp, monkeypatch):
        ...
        monkeypatch.setattr(_chat_signal_reducer, 'reduce_chat_signal', lambda _path: sentinel)
        result = _parse(ClaudeRuntime().chat_extract_signal('22222222-2222-2222-2222-222222222222'))
...
class TestRouterExtractSignalIntegration:
    def test_main_routes_chat_extract_signal_noop_end_to_end(self, tmp_path, monkeypatch, projects_at_tmp, capsys):
