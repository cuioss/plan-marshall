...
- [`owasp-top-ten.md`](owasp-top-ten.md) — A04 Cryptographic Failures (hardcoded credentials), A08 Software and Data Integrity Failures and Software Supply Chain Failures (supply-chain/CI-CD secret handling).
