...
def discover_project_modules(project_root: Path, discover_extensions_fn) -> dict:
    ...
    for ext in extensions:
        ...
        try:
            # Use cached discovery from discover_applicable_extensions() to avoid double discovery
            ...
            log_entry(
                'script', None, 'WARNING', f'[MODULE-AGGREGATION] discover_modules() failed for {bundle_name}: {e}'
            )
