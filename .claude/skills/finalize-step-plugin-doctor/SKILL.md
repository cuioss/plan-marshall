...
3. **Scoped mode** (the common case) — neither whole-tree condition holds; Step 5 scopes the gate to the skill directories extracted in Step 2 **and emits the loud cross-skill divergence WARNING** described below.
