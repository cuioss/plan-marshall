...
- [`../../../plan-marshall/skills/manage-execution-manifest/standards/decision-rules.md`](../../../plan-marshall/skills/manage-execution-manifest/standards/decision-rules.md) — `commit_push_disabled` pre-filter, the only compose-time subtraction that drops the consumer step
