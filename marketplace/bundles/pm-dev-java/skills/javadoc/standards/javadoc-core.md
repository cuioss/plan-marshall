...
For general documentation principles (what/when/how to document, clarity, completeness, anti-patterns), see `plan-marshall:ref-code-quality`. This document covers JavaDoc-specific tag syntax, formatting, and Java-specific patterns.

## Java-Specific Documentation Requirements

In addition to general requirements in `plan-marshall:ref-code-quality`:
...
Beyond general documentation requirements (see `plan-marshall:ref-code-quality`):
