...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/eslint-configuration.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/eslint-rules.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/eslint-integration.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/prettier-configuration.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/stylelint-setup.md" }` before continuing.
```
