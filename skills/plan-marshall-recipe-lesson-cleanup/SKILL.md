---
name: plan-marshall-recipe-lesson-cleanup
...
recovery: "Close the lesson via 'python3 .plan/execute-script.py plan-marshall:manage-lessons:manage-lessons remove --lesson-id {lesson_id} --reason lesson-obsolete --coverage-verdict obsolete', or refine it manually before re-running the recipe."
```
