...
> `500-plugin-doctor-detectors-report-clean-over-unexamined-populations` and landed. Do not emit it. The run artifacts — `report-01.md`,
> `verification.md`, `gaps.md` — are at `cloud-runs/500-plugin-doctor-detectors-report-clean-over-unexamined-populations/`; the landing analysis is at
> `landings/PLAN-TRUTH-083.md`. Installed here at the 2026-08-22 ingestion so the queue↔spec
