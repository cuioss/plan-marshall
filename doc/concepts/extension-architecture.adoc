...
* link:../../marketplace/bundles/plan-marshall/skills/extension-api/SKILL.md[`extension-api/SKILL.md`] — overview index of all 14 extension-point contracts: the nine domain-facing points (build, verify, triage, recipe, outline, provider, execution-context-workflow, dynamic-level-executor, self-review-surfacing) plus the core-side finalize-step, lane-element, domain-bundle, retrospective, and build-verify-step contracts.
