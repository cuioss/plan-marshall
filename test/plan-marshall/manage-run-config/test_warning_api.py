...
def test_warning_add_skips_duplicate(plan_context):
...
def test_warning_list_empty(plan_context):
...
def test_warning_remove_existing(plan_context):
...
def test_warning_remove_nonexistent(plan_context):
...
def test_warning_add_with_build_system(plan_context):
...
def test_cli_warning_add_invalid_category(plan_context):
