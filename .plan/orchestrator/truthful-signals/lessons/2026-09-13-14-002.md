...
Distinct from the corpus's existing matched-control lessons (`2026-09-04-08-012`,
`2026-09-07-21-001`, `2026-09-11-15-001`), which target test-battery authoring: this
one targets the triage FIX-task specification step itself — the obligation belongs
on the person/process writing the fix task, before any test exists to pin it.
