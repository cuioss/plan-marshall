...
| `plan.phase-6-finalize.steps.<step>.lane` (per-element override `off`\|`minimal`\|`auto`\|`full`\|`ask`) | User config | manage-execution-manifest (lane resolution) | [ext-point-lane-element.md](ext-point-lane-element.md) |
