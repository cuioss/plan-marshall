...
* link:effort-variants.adoc[doc/effort-variants.adoc] — entry-point map for the per-role model system
...
* link:../marketplace/bundles/plan-marshall/skills/plan-marshall/standards/effort-roles.md[`effort-roles.md`] — 15-key hierarchical registry
