...
The skill itself follows **reference-mode** loading — it doesn't execute logic; it pulls in link:../../marketplace/bundles/plan-marshall/skills/dev-general-practices/standards/agent-behavior-rules.md[`standards/agent-behavior-rules.md`] and (on demand) related standards files. The hard rules live there; the skill is the loader.
