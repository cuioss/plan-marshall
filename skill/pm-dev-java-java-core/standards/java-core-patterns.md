...
For general code organization principles (SRP, CQS, complexity thresholds, error handling), see `plan-marshall:ref-code-quality`. This document covers Java-specific patterns, idioms, and conventions.
...
Java-specific exception rules beyond the general principles in `plan-marshall:ref-code-quality`:
...
* See `plan-marshall:ref-code-quality` for general comment principles
