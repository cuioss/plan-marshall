---
name: plan-marshall-manage-logging
...
The canonical argparse surface for `manage-logging.py`. The plugin-doctor `missing-canonical-block` rule checks that this section is PRESENT,
