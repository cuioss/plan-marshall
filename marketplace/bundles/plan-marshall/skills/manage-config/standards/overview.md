...
The `manage-config` skill manages `.plan/marshal.json`, providing a centralized configuration for:
...
Created by `/marshall-steward` wizard or `manage-config init`.
