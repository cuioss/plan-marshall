...
**Full Structure**: See `plan-marshall:manage-solution-outline/standards/deliverable-contract.md` for the complete deliverable structure including Metadata, Profiles, and Verification fields.
