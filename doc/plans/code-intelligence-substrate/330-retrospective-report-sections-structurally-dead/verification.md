...
| 3. `_executive-summary` has no producer | **OPEN** | No producer in the tree; `report-structure.md:13` still lists Executive Summary as section 1 of what "the compiler must emit", so the shipped report carries none |
