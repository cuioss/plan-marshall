# Archived lesson 2026-09-07-15-007 — incorporated into epic process-compliance

> Provenance: moved from `.plan/local/lessons-learned/2026-09-07-15-007.md` at operator
> direction. Epic target: WS-06 / PLAN-07-opencode-repairs (unattended-order merge
> authorization; epic §G proposal 6). Source status at move: active. Body below is
> verbatim.

id=2026-09-07-15-007
