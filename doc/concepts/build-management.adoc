...
#   module:           my-module
#   command:          verify
#   executable:       "python3 .plan/execute-script.py plan-marshall:build-python:python_build run --command-args \"verify my-module\""
#   resolution_level: module
#
# For a Maven module the executable would be:
#   "python3 .plan/execute-script.py plan-marshall:build-maven:maven run --command-args \"verify -Ppre-commit -pl my-module\""
