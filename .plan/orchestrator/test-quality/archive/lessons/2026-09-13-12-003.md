# Relocated lesson 2026-09-13-12-003 — check-outline-vs-shipped should apply the read-intent exclusion

> Moved from the global lessons corpus (`.plan/local/lessons-learned/`) into this
> epic's archive by the test-quality orchestrator, 2026-09-17. Evidence absorbed in
> the declaration-form narrative (`landings/PLAN-165.md`, resume anchors citing
> `references.json` `read_intent_files`); the aspect fix itself is unowned harness
> work. Corpus entry removed as completely covered. Original body preserved verbatim
> below.
