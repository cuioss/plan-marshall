...
When no domain-specific skill is configured, the generic sub-skill instructions from `plan-marshall:outline-change-type/standards/change-{type}.md` are used as fallback.
