...
4. Log Analysis — renders the `log_analysis` aspect fragment as counts, slowest scripts, the cumulative `script_cost_rollup` (read beside the per-call slowest/percentile fields — see `log-analysis.md`), and top error tags.
