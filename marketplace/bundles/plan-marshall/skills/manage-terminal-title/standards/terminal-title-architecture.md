...
sets the token), `marshall-steward-claude-wizards/references/menu-terminal-title.md` (**Claude only**), and this
document.
...
`plan-marshall/references/hook-authoring-guide.md`,
`marshall-steward-claude-wizards/references/menu-terminal-title.md` (**Claude only**), and this document.
