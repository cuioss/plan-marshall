...
**Script**: `plan-marshall:planning-inventory`

```bash
python3 .plan/execute-script.py plan-marshall:planning-inventory:scan-planning-inventory scan
```
...
**Examples**:
```bash
python3 .plan/execute-script.py plan-marshall:planning-inventory:scan-planning-inventory scan --format full
python3 .plan/execute-script.py plan-marshall:planning-inventory:scan-planning-inventory scan --format summary
```
...
```bash
python3 .plan/execute-script.py plan-marshall:planning-inventory:scan-planning-inventory scan --include-descriptions
```
