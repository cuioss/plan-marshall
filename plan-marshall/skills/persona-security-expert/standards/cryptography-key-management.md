...
- [`owasp-top-ten.md`](owasp-top-ten.md) — A04 Cryptographic Failures (the OWASP Top 10 risk this document addresses) and A02 Security Misconfiguration (security headers, HSTS).
