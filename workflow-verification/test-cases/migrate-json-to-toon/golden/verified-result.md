...
| File | Reason |
|------|--------|
| plan-marshall/skills/tools-planning-inventory/SKILL.md | ```json output blocks |
...
affected_files[12]:
  ...
  marketplace/bundles/plan-marshall/skills/tools-planning-inventory/SKILL.md
  ...
  # Test files (4)
  test/plan-marshall/tools-planning-inventory/test_scan_planning_inventory.py
