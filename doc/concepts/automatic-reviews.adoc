...
image::../resources/diagrams/findings-pipeline.svg[Findings pipeline — producers add to manage-findings store; consumers query and resolve, dispatching per-finding ext-triage-{domain} skills, align=center]
