---
name: plan-marshall-manage-solution-outline
...
The canonical argparse surface for `manage-solution-outline.py`. The plugin-doctor `missing-canonical-block` rule checks that this section is PRESENT,
