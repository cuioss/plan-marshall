...
8. PLAN-LH2-08 (WS-03)
9. PLAN-LH2-09 (WS-02)
10. PLAN-LH2-10 (WS-02)
11. PLAN-LH2-11 (WS-02)
12. PLAN-LH2-12 (WS-01)
13. PLAN-LH2-13 (WS-01)
14. PLAN-LH2-14 (WS-01)
15. PLAN-LH2-15 (WS-01)
16. PLAN-LH2-16 (WS-01)
17. PLAN-LH2-17 (WS-03)
18. PLAN-LH2-18 (WS-04)
19. PLAN-LH2-19 (WS-01)
...
- PLAN-LH2-18 — the only cluster this epic keeps. Its subject is the corpus itself, and
  three of its inputs are first-party observations from this run's own scan.
...
|---|------|------------|--------|--------------------|
| 1 | PLAN-LH2-01 | WS-01 | staged | (spec missing) |
| 2 | PLAN-LH2-02 | WS-01 | staged | (spec missing) |
| 3 | PLAN-LH2-03 | WS-01 | staged | (spec missing) |
| 4 | PLAN-LH2-04 | WS-01 | staged | (spec missing) |
| 5 | PLAN-LH2-05 | WS-01 | staged | (spec missing) |
| 6 | PLAN-LH2-06 | WS-01 | staged | (spec missing) |
| 7 | PLAN-LH2-07 | WS-01 | staged | (spec missing) |
| 8 | PLAN-LH2-08 | WS-03 | staged | (spec missing) |
| 9 | PLAN-LH2-09 | WS-02 | staged | (spec missing) |
| 10 | PLAN-LH2-10 | WS-02 | staged | (spec missing) |
| 11 | PLAN-LH2-11 | WS-02 | staged | (spec missing) |
| 12 | PLAN-LH2-12 | WS-01 | staged | (spec missing) |
| 13 | PLAN-LH2-13 | WS-01 | staged | (spec missing) |
| 14 | PLAN-LH2-14 | WS-01 | staged | (spec missing) |
| 15 | PLAN-LH2-15 | WS-01 | staged | (spec missing) |
| 16 | PLAN-LH2-16 | WS-01 | staged | (spec missing) |
| 17 | PLAN-LH2-17 | WS-03 | staged | (spec missing) |
| 18 | PLAN-LH2-18 | WS-04 | staged | (spec missing) |
| 19 | PLAN-LH2-19 | WS-01 | staged | (spec missing) |
...
- ⛔⛔ **`manage-lessons remove` DESTROYED a lesson while reporting `not_found`
  ...
  **Unestablished:** whether the unlink precedes the metadata read, or the tombstone write
  failed after a successful unlink. Owned by PLAN-LH2-18.
...
- ⛔ **Eleven lessons carry a title and no body at all** — `add` allocated the stub,
  ...
  producer, and whether the bodies were ever written. Owned by PLAN-LH2-18.
