...
```text
Call the `skill` tool with `{ name: "pm-plugin-development-plugin-architecture" }` before continuing.
...
```text
Call the `read` tool with `{ filePath: "references/component-update-guide.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "references/knowledge-management-guide.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "references/readme-maintenance-guide.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "references/refactoring-strategies-guide.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "references/orchestration-compliance.md" }` before continuing.
```
