...
|-----------|------|---------|-------------|
| `target` | string | (required) | File path or directory path to review |
| `stop_on_error` | boolean | true | Stop on format errors (Phase 1 failure) |
| `apply_fixes` | boolean | false | Attempt to auto-fix issues (format and links) |
| `skip_content` | boolean | false | Skip Phase 3 (content review) |
