---
name: plan-marshall-manage-files
...
The canonical argparse surface for `manage-files.py`. The plugin-doctor `missing-canonical-block` rule checks that this section is PRESENT,
