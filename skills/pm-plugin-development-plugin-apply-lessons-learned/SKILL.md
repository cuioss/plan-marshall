---
name: pm-plugin-development-plugin-apply-lessons-learned
...
/pm-plugin-development-plugin-apply-lessons-learned command=maven-build-and-fix
/pm-plugin-development-plugin-apply-lessons-learned agent=maven-builder
/pm-plugin-development-plugin-apply-lessons-learned skill=builder-maven-rules

# Apply all unapplied lessons across components
/pm-plugin-development-plugin-apply-lessons-learned --all

# List unapplied lessons (dry-run)
/pm-plugin-development-plugin-apply-lessons-learned --list

# Show usage
/pm-plugin-development-plugin-apply-lessons-learned
```
...
```text
Call the `view_file` tool on `plan-marshall-manage-lessons/SKILL.md` before continuing.
```
