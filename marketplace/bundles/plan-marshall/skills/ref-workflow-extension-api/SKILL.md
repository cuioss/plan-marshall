...
|-------|-------|----------------|
| 1-init | `plan-marshall:phase-1-init` | Create plan, config, status |
| 2-refine | `plan-marshall:phase-2-refine` | Clarify request until confidence threshold |
| 3-outline | `plan-marshall:phase-3-outline` | Create solution outline with deliverables |
| 4-plan | `plan-marshall:phase-4-plan` | Transform deliverables into tasks |
| 5-execute | `plan-marshall:phase-5-execute` | Coordinate task execution + verification + triage |
| 6-finalize | `plan-marshall:phase-6-finalize` | Commit, PR, automated review |
...
- `plan-marshall:phase-1-init` - Initializes plan
- `plan-marshall:phase-2-refine` - Clarifies request until confidence threshold
- `plan-marshall:phase-3-outline` - Creates solution outline, loads outline extensions
- `plan-marshall:phase-4-plan` - Creates tasks from deliverables
- `plan-marshall:phase-5-execute` - Coordinates execution, verification, loads triage extensions
- `plan-marshall:phase-6-finalize` - Commits, creates PR, automated review

**Profile Resolution**:
- `plan-marshall:manage-config resolve-workflow-skill` - Resolves profile skill with fallback

**Extension Discovery**:
- `plan-marshall:extension-api` - ExtensionBase with provides_*() methods
- `plan-marshall:manage-config resolve-workflow-skill-extension` - Resolves extensions
- `plan-marshall:manage-config list-recipes` - Lists all available recipes
- `plan-marshall:manage-config resolve-recipe` - Resolves specific recipe by key

**Visual Overview**:
- [ref-workflow-architecture](../ref-workflow-architecture/SKILL.md) - High-level diagrams
