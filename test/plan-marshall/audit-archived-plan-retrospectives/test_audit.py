...
# ---------------------------------------------------------------------------
# #812 end_time-presence markers (metrics + input-integrity), read three-state
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# billing-composition: registration + the two index surfaces over the check set
# ---------------------------------------------------------------------------

_AUDIT_SOURCE = _AUDIT_SCRIPTS_DIR / "audit.py"
_SKILL_DIR = _AUDIT_SCRIPTS_DIR.parent
