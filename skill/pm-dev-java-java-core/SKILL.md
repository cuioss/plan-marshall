...
```text
Call the `read` tool with `{ filePath: "standards/java-core-patterns.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/java-17-features.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/java-21-features.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/java-25-features.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/java-concurrency.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/java-performance-patterns.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/dsl-constants.md" }` before continuing.
```
