#!/usr/bin/env python3
"""Unit tests for _discover_packages() files collection.

Tests that _discover_packages() correctly lists direct .java files
...
from _maven_cmd_discover import _discover_packages  # noqa: E402
