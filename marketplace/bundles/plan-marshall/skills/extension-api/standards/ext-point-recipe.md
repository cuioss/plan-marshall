...
> **Type**: Workflow Skill Extension | **Hook Method**: `provides_recipes()` | **Implementations**: 8 | **Status**: Active
...
| plan-marshall | recipe-agentfile-hygiene | agentfile-hygiene |
| plan-marshall | recipe-surgical-fix | surgical-fix |
