...
# ===========================================================================
# Structural contract around the executor
# (relocated from test/plan-marshall/test_phase_6_finalize_ci_verify.py)
# ===========================================================================
#
# The tests above pin the executor's internals; the tests below pin the
# contract that SURROUNDS it — the ``consume-failures`` precondition mode the
# dispatcher drives the step with, ci-verify's canonical position in the
# default phase-6 step set and in required-steps.md, its HEAD_DEPENDENT_STEPS
# membership, and the taxonomy enumerated by ``standards/ci-verify.md``. They
# lived in a root-level straggler module; that duplicated the skill's test home
# for no benefit, so they were folded in here verbatim.
