...
**Script**: `plan-marshall:tools-marketplace-inventory`
...
```bash
python3 ${PLUGIN_ROOT}/plan-marshall/*/skills/tools-marketplace-inventory/scripts/scan-marketplace-inventory.py
```
...
```bash
python3 .plan/execute-script.py plan-marshall:tools-marketplace-inventory:scan-marketplace-inventory --scope marketplace
python3 .plan/execute-script.py plan-marshall:tools-marketplace-inventory:scan-marketplace-inventory --scope project
```
...
```bash
python3 .plan/execute-script.py plan-marshall:tools-marketplace-inventory:scan-marketplace-inventory --resource-types agents,skills
```
...
**Example**:
```bash
python3 .plan/execute-script.py plan-marshall:tools-marketplace-inventory:scan-marketplace-inventory --include-descriptions
```
...
```bash
# Single pattern
python3 .plan/execute-script.py plan-marshall:tools-marketplace-inventory:scan-marketplace-inventory --name-pattern "*-plan-*"

# Multiple patterns (pipe-separated)
python3 .plan/execute-script.py plan-marshall:tools-marketplace-inventory:scan-marketplace-inventory --name-pattern "*-plan-*|*-specify-*|plan-*|manage-*"
```
...
```bash
# Single bundle
python3 .plan/execute-script.py plan-marshall:tools-marketplace-inventory:scan-marketplace-inventory --bundles planning

# Multiple bundles
python3 .plan/execute-script.py plan-marshall:tools-marketplace-inventory:scan-marketplace-inventory --bundles "planning,pm-dev-java,pm-dev-frontend"
```
