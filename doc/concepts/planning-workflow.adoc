...
The enforcement-critical recipe-match process steps and the auto-route gate semantics live in link:../../marketplace/bundles/plan-marshall/skills/phase-1-init/SKILL.md[`phase-1-init/SKILL.md`] Step 5c. The recipe shortcut itself is described in xref:recipes.adoc[Concepts › Recipes].
