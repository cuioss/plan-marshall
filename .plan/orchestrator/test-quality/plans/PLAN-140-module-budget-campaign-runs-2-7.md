...
- OBSERVED: the whole-tree `test-module-line-budget` count is a MOVING population and this spec
  ...
  - verdict: contradicted | checked_at: 7d82d5d906c62312c708ac8993dc5f8f4d46bfa6 | by: test-quality/cleanup | rescoped: yes | evidence: re-derived at HEAD 7d82d5d906c6 via doctor-marketplace test-conventions (whole tree): test-module-line-budget is 429, not the 362 last recorded - trajectory 267->270->279->306->324->330->350->351->362->429, still rising at every measurement (+67 since fb8aadc9c). Whole-tree total_issues 467, error_count 2, warning_count 465. _test_shape_scan.py is now 979 lines (wc -l), not 636 - over the 400 budget by 579, not 236. The no-point-figure re-scope is validated again: the number moved by 18 percent between two cleanups.
- ⛔ OBSERVED — **the attribution no longer sums with zero residual, but NOT for the reason previously
  ...
  - verdict: contradicted | checked_at: 7d82d5d906c62312c708ac8993dc5f8f4d46bfa6 | by: test-quality/cleanup | rescoped: yes | evidence: re-ran epic-surface-partition partition/attribution at HEAD 7d82d5d906c6. unclaimed is still literally 0, but the claim is now VACUOUS rather than corroborated: not_derivable is 1335 of 1337 modules and the owner buckets table holds only <not-derivable> 420 and PLAN-181 2. The supporting evidence is gone - the restructure commit 7d82d5d90 (#1578) archived PLAN-080's spec out of plans/, and test/pm-plugin-development/cloud-plan-lane/test_build_gate_lockstep.py now resolves not_derivable under PLAN-140, not claimed under PLAN-080. The claim cannot be re-grounded as written until the corpus has specs to attribute against again - a re-scope, not a re-measurement, is owed.
- ✅ OBSERVED — **the blocker is CLEARED**: this row formerly recorded that the per-slice attribution
  ...
  - verdict: contradicted | checked_at: 7d82d5d906c62312c708ac8993dc5f8f4d46bfa6 | by: test-quality/cleanup | rescoped: yes | evidence: re-ran epic-surface-partition attribution at HEAD 7d82d5d906c6: every per-plan bucket recorded at bf1b7ed6 is gone. Current buckets are <not-derivable> 420 and PLAN-181 2 over findings_total 422 (modules_total 1337); contested is 0, not 108. Cause is the HEAD restructure 7d82d5d90 (#1578), which left only 2 staged specs in plans/ (PLAN-140 derived, PLAN-181 declarative), so PLAN-030/040/050/080/155/165/020's buckets no longer have specs to attribute against. PLAN-170 itself is still shipped - settled.md's single-bucket attribution defect section records it shipped as #1385 - and is absent from status.json plans[] which now carries only PLAN-140 parked and PLAN-181 staged. Re-scope owed, not a re-measurement.
- OBSERVED: run 6's campaign figure of 42 is stale — the current figure is **61** at `bf1b7ed6`
  ...
  - verdict: contradicted | checked_at: 7d82d5d906c62312c708ac8993dc5f8f4d46bfa6 | by: test-quality/cleanup | rescoped: yes | evidence: re-derived at HEAD 7d82d5d906c6 (doctor-marketplace test-conventions, grouped by top-level test dir): test/pm-plugin-development is 48, extending the both-directions sequence 42->49->61->46->48. Full slice distribution over 429 findings: test/plan-marshall 355, test/pm-plugin-development 48, test/marketplace 9, test/_shared 3, test/default 2, test/sync-plugin-cache 2, plus 10 singletons. test/plan-marshall moved 293->355 (+62) and test/marketplace 7->9. These remain LEADS for D1, not a sizing table.
- OBSERVED: run 7's single module is `test_test_conventions_rule6.py` at 681 lines, over by 281
  - verdict: corroborated | checked_at: 7d82d5d906c62312c708ac8993dc5f8f4d46bfa6 | by: test-quality/cleanup | rescoped: n/a | evidence: re-measured with wc -l at HEAD 7d82d5d906c6: test/pm-plugin-development/plugin-doctor/test_test_conventions_rule6.py is exactly 681 lines, unchanged across bf1b7ed6, 9853a7ab, fb8aadc9c and now this HEAD - stable across six landings. Still over the 400 budget by 281 and still flagged by its own rule.
- ✅ OBSERVED — **CLOSED by PLAN-105 § D3 (#1407)**: the budget rule formerly filtered on
  ...
  - verdict: contradicted | checked_at: 7d82d5d906c62312c708ac8993dc5f8f4d46bfa6 | by: test-quality/cleanup | rescoped: yes | evidence: the widened predicate is INTACT (no regression of PLAN-105 D3 - _analyze_test_conventions.py:897-914 still measures every module, helper included) but both figures moved: 10 non-test_-prefixed files now appear among 429 findings (conftest.py plus 9 underscore modules), not 7 among 330. Re-scoped to name the current count rather than the stale one.
- OBSERVED: run 1's PR reached **309 files** and **both** automated reviewers refused it on file-count
  ...
  - verdict: contradicted | checked_at: 7d82d5d906c62312c708ac8993dc5f8f4d46bfa6 | by: test-quality/cleanup | rescoped: yes | evidence: the cited source no longer exists at HEAD: git log -- .plan/orchestrator/test-quality/landings/PLAN-100.md shows the file was DELETED by HEAD commit 7d82d5d90 (#1578, restructure epics into a fresh live/archived split); the whole landings/ directory is gone for this epic. The historical fact is intact and unchanged - git show 7d82d5d90^:.plan/orchestrator/test-quality/landings/PLAN-100.md lines 52-53 still read the PR reached 309 files and both automated reviewers refused it on file-count ceilings (100 and 300). Contradicted on the citation, not the fact: the anchor is dangling and needs re-pointing to archive/100-module-budget-campaign/report-01.md.
- HYPOTHESIS — **re-derive per run; the table is a lead**: each row's count still holds at dispatch time
  ...
  - verdict: unverifiable | checked_at: 7d82d5d906c62312c708ac8993dc5f8f4d46bfa6 | by: test-quality/cleanup | rescoped: n/a | evidence: unchanged and unchanged for the same reason: this is an explicit verify-at-outline deferral over the whole slice table rather than a checkable aggregate, still true at HEAD 7d82d5d906c6. Its per-row figures are measured separately and carry their own verdicts above. Re-stamped at this HEAD so the record shows the question was re-asked rather than forgotten.
