"""
Credential extension for Git integration.

Extension point: plan-marshall:extension-api/standards/ext-point-provider

Declares credential requirements for the workflow-integration-git skill.
...
def get_credential_providers():
    """Return credential provider declarations for Git integration."""
    return [
        {
