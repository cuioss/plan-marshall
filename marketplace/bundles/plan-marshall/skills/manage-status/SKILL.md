...
| `partial` | The cohort was enumerated, but at least one member could not be read. | `population` (what was found), `open_phase_count`, `unreadable_count` (**non-zero**), `reason` naming the members. |
