...
|6. Finalize
|`phase-6-finalize`
|Git workflow, finalize-step pipeline (deploy-target, sync-plugin-cache, plugin-doctor, pre-submission self-review, post-run review), commit, push, and PR creation.
|===
