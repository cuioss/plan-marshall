...
kind=finding
created=2026-09-23T07:24:41Z

# Forward from `deployment-configurability` (API-Sheriff) — five flag-shape/verb-surface argparse rejections across five different scripts, in one plan run
