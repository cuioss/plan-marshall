---
name: pm-plugin-development-verification-mode
...
```text
Call the `view_file` tool on `pm-plugin-development-verification-mode/SKILL.md` before continuing.
```
...
```text
Call the `view_file` tool on `pm-plugin-development-verification-mode/SKILL.md` before continuing.
Call the `view_file` tool on `plan-marshall-phase-3-outline/SKILL.md` before continuing.
```
...
```text
Call the `view_file` tool on `plan-marshall-plan-retrospective/SKILL.md` before continuing.
```
