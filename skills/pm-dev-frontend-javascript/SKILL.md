---
name: pm-dev-frontend-javascript
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/javascript-fundamentals.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/code-quality.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/modern-patterns.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/async-programming.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/jsdoc-essentials.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/jsdoc-patterns.md" }` before continuing.
```
