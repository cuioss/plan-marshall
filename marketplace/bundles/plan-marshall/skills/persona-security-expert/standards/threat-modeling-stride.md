...
- **Information disclosure → Confidentiality**: encryption at rest and in transit (TLS 1.2+/1.3), authorization-based access, DLP, data minimization, generic non-revealing error messages (no stack traces). (Cryptographic detail maps to [`owasp-top-ten.md`](owasp-top-ten.md) A02.)
