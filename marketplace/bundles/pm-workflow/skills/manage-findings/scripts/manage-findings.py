...
Usage:
    python3 manage-findings.py add <plan_id> <type> <title> --detail <detail> [options]
    python3 manage-findings.py query <plan_id> [options]
    python3 manage-findings.py get <plan_id> <hash_id>
    python3 manage-findings.py resolve <plan_id> <hash_id> <resolution> [options]
    python3 manage-findings.py promote <plan_id> <hash_id> <promoted_to>

    python3 manage-findings.py qgate add <plan_id> --phase <phase> --source <source> --type <type> --title <title> --detail <detail> [options]
    python3 manage-findings.py qgate query <plan_id> --phase <phase> [options]
    python3 manage-findings.py qgate resolve <plan_id> <hash_id> <resolution> --phase <phase> [options]
    python3 manage-findings.py qgate clear <plan_id> --phase <phase>
...
def main() -> int:
    ...
    add_parser.add_argument('type', choices=FINDING_TYPES, help='Finding type')
    ...
    get_parser.add_argument('hash_id', help='Finding hash ID')
    get_parser.set_defaults(func=cmd_get)

    # resolve
    resolve_parser = subparsers.add_parser('resolve', help='Resolve a finding')
    resolve_parser.add_argument('plan_id', help='Plan identifier')
    resolve_parser.add_argument('hash_id', help='Finding hash ID')
    resolve_parser.add_argument('resolution', choices=RESOLUTIONS, help='Resolution status')
    ...
    promote_parser.add_argument('plan_id', help='Plan identifier')
    promote_parser.add_argument('hash_id', help='Finding hash ID')
    promote_parser.add_argument('promoted_to', help='Target ID or "architecture"')
