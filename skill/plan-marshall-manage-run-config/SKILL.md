---
name: plan-marshall-manage-run-config
...
|--------|----------------|--------|
| `temp` | `temp_on_maintenance` | The project-local `.plan/temp/` scratch tree |
