...
Usage:
    ...
    python3 test/run-tests.py test/plan-marshall/     # Run tests in directory
    python3 test/run-tests.py test/plan-marshall/plan-files/test_parse_plan.py  # Run single test
