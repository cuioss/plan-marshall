...
target=$(python3 .plan/execute-script.py plan-marshall:manage-config:manage-config \
  models resolve-target --role phase-6.pre-submission-self-review)
```
