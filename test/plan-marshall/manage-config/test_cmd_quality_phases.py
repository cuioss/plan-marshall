...
def test_execute_set_steps():
    ...
    with PlanContext() as ctx:
        ...
        result = run_script(
            ...
            'set-steps',
            '--steps',
            'default:quality_check,default:build_verify,pm-dev-java:java-coverage-agent',
        )
...
def test_execute_add_step():
    ...
    with PlanContext() as ctx:
        ...
        assert 'pm-dev-java:java-coverage-agent' in steps
        assert steps[-1] == 'pm-dev-java:java-coverage-agent'
