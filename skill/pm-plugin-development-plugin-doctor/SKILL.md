---
name: pm-plugin-development-plugin-doctor
...
3. **Discover Components** (based on scope parameter)
   ...
   - global scope: Glob the user-global deployment root (resolved via the shared layout helper; Claude: `~/.claude/{component}/`)
