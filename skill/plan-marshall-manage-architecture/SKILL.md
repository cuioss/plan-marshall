---
name: plan-marshall-manage-architecture
...
The canonical argparse surface for `architecture.py`. The plugin-doctor `missing-canonical-block` rule checks that this section is PRESENT,
