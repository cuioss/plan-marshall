...
- [`owasp-top-ten.md`](owasp-top-ten.md) — A04 Cryptographic Failures (hardcoded credentials), A03 Software Supply Chain Failures (supply-chain/CI-CD secret handling).
