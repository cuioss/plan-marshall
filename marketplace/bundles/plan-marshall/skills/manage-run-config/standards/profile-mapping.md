...
```bash
python3 .plan/execute-script.py plan-marshall:manage-run-config:run_config profile-mapping get \
  --profile-id jfr
```
...
```bash
# List all mappings
python3 .plan/execute-script.py plan-marshall:manage-run-config:run_config profile-mapping list
...
```bash
python3 .plan/execute-script.py plan-marshall:manage-run-config:run_config profile-mapping remove \
  --profile-id jfr
```
