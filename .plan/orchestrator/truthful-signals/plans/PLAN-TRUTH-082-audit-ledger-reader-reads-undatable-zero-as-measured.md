...
> `460-audit-ledger-reader-reads-undatable-zero-as-measured` and landed. Do not emit it. The run artifacts — `report-01.md`,
> `verification.md`, `gaps.md` — are at `cloud-runs/460-audit-ledger-reader-reads-undatable-zero-as-measured/`; the landing analysis is at
> `landings/PLAN-TRUTH-082.md`. Installed here at the 2026-08-22 ingestion so the queue↔spec
