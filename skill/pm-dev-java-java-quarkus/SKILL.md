...
```text
Call the `read` tool with `{ filePath: "standards/quarkus-testing.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/quarkus-native.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/quarkus-reflection.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/container.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/quarkus-rest-validation.md" }` before continuing.
```
