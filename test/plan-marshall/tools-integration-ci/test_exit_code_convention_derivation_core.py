...
def test_partial_clause_set_does_not_count_as_stating_the_contract(tmp_path):
    ...
    assert _causes.states_full_contract(NARROW_CONVENTION) is False, (
    ...
    assert _causes.states_full_contract(FULL_CONTRACT_CONVENTION) is True, (
...
def test_a_manage_heading_stating_every_clause_is_still_narrow(tmp_path):
    ...
    assert _causes.states_full_contract(manage_heading_full_body) is True, (
