...
path[3]:
  ...
  - oauth-sheriff-quarkus
  - oauth-sheriff-core
resolvers[6]{id,edge_count,status,notes}:
  documentation,0,ok,[]
  markdown,0,ok,[]
  maven,7,ok,[]
  npm,0,ok,[]
