...
```text
/plan-marshall task="implement .plan/local/orchestrator/review-apparatus/plans/PLAN-PR-047-the-counting-stage-reasons-from-inputs-that-were-never-persisted.md"
```
