#!/bin/bash
# Mock Maven wrapper: Simulate build with JavaDoc warnings
...
# Create realistic build output with JavaDoc warnings (build succeeds)
cat > "$LOG_FILE" << 'EOF'
...
[INFO]
[INFO] --- maven-javadoc-plugin:3.6.0:javadoc (default) @ test-project ---
[WARNING] Javadoc Warnings
[WARNING] /src/main/java/com/example/Service.java:45: warning: no @param for userId
[WARNING] /src/main/java/com/example/Service.java:45: warning: no @return
[WARNING] /src/main/java/com/example/Handler.java:23: warning: no @param for request
[WARNING] /src/main/java/com/example/Handler.java:23: warning: no @throws for IOException
[INFO]
...
[INFO] Tests run: 8, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.892 s -- in com.example.ServiceTest
[INFO]
[INFO] Results:
[INFO]
