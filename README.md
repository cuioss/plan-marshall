...
| [Developer Guide](doc/developer/README.adoc) | Working on Plan Marshall itself — build system, marketplace generation pipeline, distribution, testing. |
...
| Bundle | Purpose |
|---|---|
| [plan-marshall](marketplace/bundles/plan-marshall/README.md) | Core infrastructure, permissions, script execution, the 6-phase planning workflow with task execution, and language-server-derived symbol intelligence for the module graph |
