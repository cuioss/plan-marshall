...
If `CLAUDE.md` exists, prompt the user via `ask_question` whether to use it as the primary source for `AGENTS.md` or to use other sources (project `doc/ai-rules.md` or global standards baseline).
...
- `ask_question` — CLAUDE.md source choice
