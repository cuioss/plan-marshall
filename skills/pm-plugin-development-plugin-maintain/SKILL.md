---
name: pm-plugin-development-plugin-maintain
...
```text
Call the `view_file` tool on `pm-plugin-development-plugin-architecture/SKILL.md` before continuing.
...
```text
Call the `view_file` tool with `{ AbsolutePath: "references/component-update-guide.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "references/knowledge-management-guide.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "references/readme-maintenance-guide.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "references/refactoring-strategies-guide.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "references/orchestration-compliance.md" }` before continuing.
```
