id=2026-09-04-08-001
component=plan-marshall:phase-6-finalize
category=bug
created=2026-09-04

> Moved from `.plan/local/lessons-learned/2026-09-04-08-001.md` into this epic's archive on
> 2026-09-17. Incorporated into `epic.md` § Open Defects as a new, unowned entry (candidate for
> a future PRQ spec — mechanism not yet established). Original tombstoned with
> `coverage_verdict: completely_covered`, covering clause
> `post-run-quality epic.md § Open Defects — "The composed manifest ran plan-retrospective before lessons-capture, so the orchestration verdict was never resolved before its first consumer"`.
...
**Carried out of the `review-apparatus` epic inbox** — message `misconfigured-reviewer-name-reads-missing-review-001.md`, sender `misconfigured-reviewer-name-reads-missing-review`, promoted by the orchestrator drain of 2026-09-04.
