...
```text
Call the `read` tool with `{ filePath: "standards/test-generator-framework.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/testing-value-objects.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/testing-juli-logger.md" }` before continuing.
```
