...
- Inline-code spans inside bash fences are exempt
...
# ---------------------------------------------------------------------------
# Inline-code span exemption
# ---------------------------------------------------------------------------


class TestInlineCodeSpanExemption:
    def test_inline_code_span_not_flagged(self, tmp_path):
        content = (
            '```bash\n'
            'echo `> /tmp/data.txt`\n'
            '```\n'
    ...
    def test_redirect_outside_inline_span_flagged(self, tmp_path):
        # The inline span contains something else; the real redirect is outside
        content = (
            '```bash\n'
