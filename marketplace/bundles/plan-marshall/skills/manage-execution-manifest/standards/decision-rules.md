...
**Condition**: `scope_estimate ∈ {surgical, single_module}` (the implicit gate), OR `lightweight_track_override == true` (the explicit `automated-review` opt-in).
