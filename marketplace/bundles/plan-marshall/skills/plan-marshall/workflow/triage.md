...
- [granularity.md](../../dev-general-practices/standards/granularity.md) § 5.1–5.2 — the shared-triage-core principle and why smart grouping beats either pure sequential or full-batch shapes. The algorithm specifics live in this doc (single source of truth); the granularity doc explains why the dispatch shape is shared across five call sites and bundled rather than per-iteration.
