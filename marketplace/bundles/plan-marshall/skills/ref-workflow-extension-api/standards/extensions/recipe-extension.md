...
|------|-------------|-------------|
| `solution_outline.md` | `plan-marshall:manage-solution-outline:manage-solution-outline write` | Deliverables grouped by module |
...
4. phase-1-init-agent creates plan with source=recipe
...
- `plan-marshall:phase-3-outline` — Recipe detection in Step 2.5
- `plan-marshall:phase-3-outline` [references/recipe-flow.md](../../phase-3-outline/references/recipe-flow.md) — Visual flow diagrams (built-in vs custom)
