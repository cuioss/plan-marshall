...
#   module:     my-module
#   command:    verify
#   executable: python3 .plan/execute-script.py plan-marshall:build-python:python_build run --module my-module --targets verify
#
