...
For general documentation principles (what/when/how to document, clarity, completeness), see `pm-dev-general:dev-documentation`. This document covers JSDoc-specific tag syntax, ESLint integration, and type annotations.
