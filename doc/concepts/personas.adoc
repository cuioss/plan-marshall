...
* xref:orchestration.adoc[Concepts › Orchestration] — `persona-plan-orchestrator`, the epic-orchestration work identity resolved through this same composition model.
