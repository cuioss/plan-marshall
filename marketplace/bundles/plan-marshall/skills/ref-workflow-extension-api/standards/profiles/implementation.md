...
**Implementation**: `plan-marshall:phase-5-execute`
...
See [ref-workflow-architecture:skill-loading](../../ref-workflow-architecture/standards/skill-loading.md) for complete visual diagrams.
...
The `phase-5-execute-agent` will:
...
│     → plan-marshall:task-implementation                       │
│                         │                                   │
│                         ▼                                   │
│  Return: { workflow_skill: plan-marshall:task-implementation, │
│            fallback: true }                                 │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```
...
The `phase-5-execute-agent` is a minimal wrapper:
...
**Callers**:
- `plan-execute` skill → spawns phase-5-execute-agent
