...
* xref:orchestration.adoc[Concepts › Orchestration] — `persona-marshall-orchestrator`, the epic-orchestration work identity resolved through this same composition model.
