...
```text
Call the `read` tool with `{ filePath: "standards/javascript-fundamentals.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/code-quality.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/modern-patterns.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/async-programming.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/jsdoc-essentials.md" }` before continuing.
```
...
```text
Call the `read` tool with `{ filePath: "standards/jsdoc-patterns.md" }` before continuing.
```
