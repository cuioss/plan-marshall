...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/testing-junit-core.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/testing-integration.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/testing-async-patterns.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/coverage-analysis-pattern.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "templates/unit-test-class.java.tmpl" }` before continuing.
```
