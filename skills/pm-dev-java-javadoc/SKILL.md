...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/javadoc-core.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/javadoc-class-documentation.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/javadoc-method-documentation.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/javadoc-code-examples.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "standards/javadoc-error-reference.md" }` before continuing.
```
...
```text
Call the `view_file` tool with `{ AbsolutePath: "templates/javadoc-class.java.tmpl" }` before continuing.
```
