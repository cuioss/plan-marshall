...
If `CLAUDE.md` exists, prompt the user via `question` whether to use it as the primary source for `agents.md` or to use other sources (project `doc/ai-rules.md` or global standards baseline).
...
- `question` — CLAUDE.md source choice
