...
- [dispatch-walkthrough.md](dispatch-walkthrough.md) — Worked end-to-end traces of three representative dispatches: phase-2-refine entry, phase-6 automated-review with `verification-feedback` (producer=pr-comment), phase-6 architecture-refresh Tier-1 fan-out
