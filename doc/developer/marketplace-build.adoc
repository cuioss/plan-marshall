...
The `marketplace/targets/claude/emitter.py` reader walks each bundle. For an agent declaring `implements: plan-marshall:extension-api/standards/ext-point-dynamic-level-executor`, the emitter produces up to seven files:
