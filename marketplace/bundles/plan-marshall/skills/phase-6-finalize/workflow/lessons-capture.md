...
- `signal_automated_review_count` — integer (0 or 1); 1 when `automated-review` outcome is anything other than `done`, or its `display_detail` reports a non-zero promoted-comment count.
