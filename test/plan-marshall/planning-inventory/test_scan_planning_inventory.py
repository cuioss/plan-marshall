...
# Script under test
SCRIPT_PATH = get_script_path('plan-marshall', 'planning-inventory', 'scan-planning-inventory.py')
...
def test_java_and_frontend_not_in_derived():
    ...
    assert 'pm-dev-frontend' not in bundle_names, (
        'pm-dev-frontend should NOT be in derived (planning components removed)'
    )
