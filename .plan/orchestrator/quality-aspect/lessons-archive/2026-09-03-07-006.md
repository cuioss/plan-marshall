id=2026-09-03-07-006
component=pm-plugin-development:ext-self-review-plan-marshall
category=anti-pattern
status=active
created=2026-09-03

# Hoisting a binding to the top of a file leaves later rebindings shadowing it, invisibly to a green suite
...
Promoted by the orchestrator (`test-quality` epic) from inbox message `plan-150-close-the-namespace-conversion-010.md`, filed by `plan-150-close-the-namespace-conversion` (PR #1383).
