#!/usr/bin/env python3
"""
Shared helpers for triage-style workflow scripts (pr.py, sonar.py).

Eliminates boilerplate for single-item and batch triage command handlers
that parse JSON input, delegate to a triage function, and emit TOON output.

Usage:
    from triage_helpers import cmd_triage_single, cmd_triage_batch_handler
"""
