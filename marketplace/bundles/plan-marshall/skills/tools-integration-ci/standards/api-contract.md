...
| `pr wait-for-comments` | `--pr-number` | `--timeout` (default 300), `--interval` (default 30) | `pr_number`, `timed_out`, `duration_sec`, `polls`, `baseline_count`, `final_count`, `new_count`, `rate_limited_bots[N]{bot_kind,rate_limit_class,eta,cause,cap}`, `movement_matched_bots[N]{bot_kind}`, `detector_answerable`, `unanswerable_reason` |
