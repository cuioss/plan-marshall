...
|---|------|------------|--------|--------------------|
| 1 | PLAN-LR-01-derive-the-corpus-and-the-audience-axis | WS-01 | staged | (no expected surface) |
| 2 | PLAN-LR-02-the-ownership-predicate-answers-the-wrong-question | WS-01 | staged | marketplace/bundles/plan-marshall/skills/manage-lessons/SKILL.md |
| 3 | PLAN-LR-03-an-upstream-finding-becomes-an-issue | WS-02 | staged | (no expected surface) |
| 4 | PLAN-LR-04-route-the-corpus-that-is-already-stranded | WS-04 | staged | (no expected surface) |
| 5 | PLAN-LR-05-a-lesson-does-not-record-what-was-running-when-it-was-observed | WS-01 | staged | marketplace/bundles/plan-marshall/skills/manage-lessons/SKILL.md |
