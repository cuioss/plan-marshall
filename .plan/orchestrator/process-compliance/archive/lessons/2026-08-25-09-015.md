# Archived lesson 2026-08-25-09-015 — incorporated into epic process-compliance

> Provenance: moved from `.plan/local/lessons-learned/2026-08-25-09-015.md` at operator
> direction. Epic target: WS-02 / PLAN-02-worktree-discipline (session-restart cwd
> re-pin). Source status at move: active. Body below is verbatim.

id=2026-08-25-09-015
component=plan-marshall:plan-marshall
category=bug
status=active
created=2026-08-25

# A session restart mid-finalize silently resets cwd off the worktree, breaking every manage-* call
