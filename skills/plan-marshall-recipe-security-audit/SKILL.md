---
name: plan-marshall-recipe-security-audit
...
```text
Call the `view_file` tool with `{ AbsolutePath: "marketplace/bundles/plan-marshall/skills/recipe-security-audit/standards/audit-engine.md" }` before continuing.
```
